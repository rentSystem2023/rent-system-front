...
import { PostQnaRequestDto, PutQnaRequestDto } from 'src/apis/qna/dto/request';
...
export default function QnaUpdate() {
    ...
    const getBoardResponse = (result: GetQnaBoardListResponseDto | ResponseDto | null) => {
        ...
        const { writerId, title, contents, status } = result as GetQnaBoardResponseDto;
    ...
    //     const requestBody: PostQnaRequestDto = { title, contents};
