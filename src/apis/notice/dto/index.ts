...
export const putBoardRequest = async(registNumber: number | string, requestBody: PutQnaRequestDto , accessToken:string) =>{
...
export const deleteBoardRequest = async(registNumber: number | string, accessToken: string)=>{
