...
export const RESERVATION_SEARCH_ABSOLUTE_PATH = `/`;
// 보험별 가격 검색 결과 불러오기 URL
export const RESERVATION_INQURY_ABSOLUTE_PATH = `${RESERVATION_INSURANCE_PATH}`;
// 보험별 가격 검색 결과 상세 불러오기 URL
export const RESERVATION_INQURY_DETAIL_ABSOLUTE_PATH = `${RESERVATION_INQURY_INSURANCE_PATH}`;
// 예약하기 URL ..........??
export const RESERVATION_ABSOLUTE_PATH = ``;
// 예약 목록 리스트 불러오기 URL
export const RESERVATION_LIST_ABSOLUTE_URL = `${RESERVATION_PATH}/${RESERVATION_LIST_PATH}`;

// 공지사항 리스트 불러오기 URL
export const NOTICE_LIST_ABSOLUTE_PATH = `${NOTICE_PATH}/${NOTICE_LIST}`
// 공지사항 게시물 불러오기 URL
export const NOTICE_ABSOLUTE_DETAIL_PATH = (registNumber : number) => `${NOTICE_LIST_ABSOLUTE_PATH}/${registNumber}`;
// 관리자페이지 공지사항 작성하기 URL
export const NOTICE_REGIST_ABSOLUTE_PATH = `${NOTICE_PATH}/${NOTICE_REGIST_PATH}`;
// 공지사항 게시물 수정하기 URL
export const NOTICE_ABSOLUTE_UPDATE_PATH = (registNumber : number) => `${NOTICE_PATH}/update/${registNumber}`;

// Q&A 리스트 불러오기 URL
export const QNA_LIST_ABSOLUTE_PATH = `${QNA_PATH}/${QNA_LIST_PATH}`;
// Q&A 게시물 작성하기 URL
export const QNA_REGIST_ABSOLUTE_PATH = `${QNA_PATH}/${QNA_REGIST_PATH}`;
// Q&A 게시물 상세보기 URL
...
// 업체 리스트 불러오기 URL
export const COMPANY_LIST_ABSOLUTE_PATH = `${COMPANY_PATH}/${COMPANY_LIST_PATH}`;
// 업체 등록하기 URL
export const COMPANY_REGIST_ABSOLUTE_PATH = `${COMPANY_PATH}/${COMPANY_REGIST_PATH}`;
// 업체 정보 수정하기 URL
export const COMPANY_UPDATE_ABSOLUTE_PATH = (companyCode : number) => `${COMPANY_PATH}/update/${companyCode}`;
