...
export const USER_INFO_MODIFY_ABSOLUTE_PATH = `${MAIN_PATH}/${USER_INFO_ABSOLUTE_PATH}/${USER_UPDATE_PATH}`;
...
export const USER_DETAIL_ABSOLUTE_PATH = (userId : number) => `${MAIN_PATH}/${USER_LIST_ABSOLUTE_PATH}/${userId}`;
...
export const RESERVATION_MY_DETAIL_ABSOLUTE_PATH = (reservationCode : number) => `${MAIN_PATH}/${RESERVATION_MY_LIST_ABSOLUTE_PATH}/${reservationCode}`;
...
// Q&A 게시물 상세보기 URL
export const QNA_DETAIL_ABSOLUTE_PATH = (receptionNumber : number) => `${MAIN_PATH}/${QNA_LIST_ABSOLUTE_PATH}/${receptionNumber}`
// Q&A 게시물 수정하기 URL
...
// 사용자 정보 반환 URL
export const GET_SIGN_IN_USER_REQUEST_URL = `${MAIN_PATH}/${SERVER_USER_MODULE_URL}/`;
// 사용자 마이페이지 내 정보 URL
export const GET_MY_INFO_URL = `${MAIN_PATH}/${SERVER_USER_MODULE_URL}/information`;
// 사용자 마이페이지 내 정보 수정 URL
export const PATCH_MODIFY_MY_INFO_URL = `${MAIN_PATH}/${SERVER_USER_MODULE_URL}/information/modify`;
// 사용자 마이페이지 내 정보 삭제 URL
export const DELETE_MY_INFO_URL = `${MAIN_PATH}/${SERVER_USER_MODULE_URL}/information/modify`;

// 관리자페이지 회원 목록 리스트 URL
export const GET_USER_LIST_URL = `${MAIN_PATH}/${SERVER_USER_MODULE_URL}/list`;
// 관리자페이지 회원 목록 상세 URL
export const GET_USER_DETAIL_URL = (userId: string) => `${MAIN_PATH}/${GET_USER_LIST_URL}/${userId}`;
// 관리자페이지 회원 정보 삭제 URL
export const DELETE_USER_LIST_URL = (userId: string) => `${MAIN_PATH}/${GET_USER_LIST_URL}/${userId}`;
// 관리자 페이지 회원 목록 검색 결과 URL
export const GET_USER_LIST_SEARCH_URL = `${MAIN_PATH}/${GET_USER_LIST_URL}/search`;

// description: RESERVATION MODULE
export const SERVER_RESERVATION_MODULE_URL = `${MAIN_PATH}/${SERVER_API_URL}/reservation`;

// 마이페이지 예약 내역 URL
export const GET_MY_RESERVATION_LIST_URL = `${MAIN_PATH}/${SERVER_RESERVATION_MODULE_URL}/mylist`;
// 마이페이지 예약 상세 내역 URL
export const GET_MY_RESERVATION_DETAIL_URL = (reservationCode : number) => `${MAIN_PATH}/${GET_MY_RESERVATION_LIST_URL}/${reservationCode}`;
// 마이페이지 예약 취소 URL
export const PATCH_MY_RESERVATION_DETAIL_URL = (reservationCode : number) => `${MAIN_PATH}/${GET_MY_RESERVATION_LIST_URL}/${reservationCode}`;

// 차량 검색, 예약 모듈 URL 다시 점검 필요함
// 인기 차량 리스트, 차량 검색 결과 URL
export const GET_CAR_LIST_URL = `${MAIN_PATH}/${SERVER_API_URL}/`
// 보험별 가격 검색 결과 URL
export const GET_INSURANCE_LIST_URL = `${MAIN_PATH}/${SERVER_RESERVATION_MODULE_URL}/insurance`;
// 보험별 가격 상세 검색 결과 URL
export const GET_INSURANCE_DETAIL_LIST_URL = `${MAIN_PATH}/${SERVER_RESERVATION_MODULE_URL}/insurance-detail`;
// 예약 URL ...........??
export const POST_RESERVATION_URL = `${MAIN_PATH}/${SERVER_RESERVATION_MODULE_URL}/list/search`;

// 예약 목록 리스트 URL
export const GET_RESERVATION_LIST_URL = `${MAIN_PATH}/${SERVER_RESERVATION_MODULE_URL}/list`;
// 예약 목록 삭제 URL .........??
// export const DELETE_RESERVATION_LIST_URL = `${GET_RESERVATION_LIST_URL}`

// description: NOTICE MODULE
export const SERVER_NOTICE_MODULE_URL = `${MAIN_PATH}/${SERVER_API_URL}/notice`;

// 공지사항 목록 URL
export const GET_NOTICE_LIST_URL = `${MAIN_PATH}/${SERVER_NOTICE_MODULE_URL}/list`;
// 공지사항 검색 목록 URL
export const NOTICE_LIST_SEARCH_URL = `${MAIN_PATH}/${SERVER_NOTICE_MODULE_URL}/list/search`;
// 공지사항 게시물 상세 URL
export const GET_NOTICE_DETAIL_URL = (registNumber : number) => `${MAIN_PATH}/${GET_NOTICE_LIST_URL}/${registNumber}`;
// 공지사항 게시물 조회수 증가 URL
export const INCREASE_NOTICE_VIEW_COUNT_URL = (registNumber : number ) => `${MAIN_PATH}/${SERVER_NOTICE_MODULE_URL}/${registNumber}/increase-view-count`;
// 공지사항 게시물 작성 URL
export const POST_NOTICE_REQUESURL = `${MAIN_PATH}/${SERVER_NOTICE_MODULE_URL}/regist`;
// 공지사항 게시물 수정 URL
export const PUT_NOTICE_REGIST_URL = (registNumber : number) => `${MAIN_PATH}/${SERVER_NOTICE_MODULE_URL}/${registNumber}/modify`;
// 공지사항 게시물 삭제 URL
export const DELETE_NOTICE_URL = (registNumber : number) => `${MAIN_PATH}/${SERVER_NOTICE_MODULE_URL}/${registNumber}/delete`;

// description: Q&A MODULE
export const SERVER_QNA_MODULE_URL = `${MAIN_PATH}/${SERVER_API_URL}/qna`;

// 마이페이지 Q&A 목록 URL
export const GET_MY_QNA_LIST_URL = `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/myList`;
// 마이페이지 Q&A 목록 검색 URL
export const GET_MY_QNA_LIST_SEARCH_URL = `${MAIN_PATH}/${GET_MY_QNA_LIST_URL}/search`;
// 마이페이지 Q&A 게시물 삭제 URL
export const DELETE_QNA_LIST_URL = (receptionNumber: number | string) => `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/${receptionNumber}/delete`;
// Q&A 게시물 수정 URL
export const PUT_QNA_REGIST_URL = (receptionNumber: number | string) => `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/${receptionNumber}/modify`;

// Q&A 전체 게시물 리스트 URL
export const GET_QNA_LIST_URL = `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/list`;
// Q&A 게시물 검색 리스트 URL
export const GET_QNA_LIST_SEARCH_URL = `${MAIN_PATH}/${GET_QNA_LIST_URL}/search`;
// Q&A 게시물 상세 URL
export const GET_QNA_DETAIL_URL = (receptionNumber : number | string) => `${MAIN_PATH}/${GET_QNA_LIST_URL}/${receptionNumber}`;
// Q&A 게시물 작성 URL
export const POST_QNA_REGIST_URL = `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/regist`;
// Q&A 게시물 조회수 증가 URL
export const INCREASE_QNA_VIEW_COUNT_URL = (receptionNumber: number | string) => `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/${receptionNumber}/increase-view-count`;

// Q&A 답변 URL
export const POST_COMMENT_REQUEST_URL = (receptionNumber : number | string) => `${MAIN_PATH}/${SERVER_QNA_MODULE_URL}/${receptionNumber}/comment`;

// description: COMPANY MODULE
export const SERVER_COMPANY_MODULE = `${MAIN_PATH}/${SERVER_API_URL}/company`;

// 업체 정보 전체 리스트 URL
export const GET_COMPANY_LIST_URL = `${MAIN_PATH}/${SERVER_COMPANY_MODULE}/list`;
// 업체 정보 검색 리스트 URL
export const GET_COMPANY_LIST_SEARCH_URL = `${MAIN_PATH}/${GET_COMPANY_LIST_URL}/search`;
// 업체 정보 등록 URL
export const POST_COMPANY_REGIST_URL = `${MAIN_PATH}/${SERVER_COMPANY_MODULE}/regist`;
// 업체 정보 수정 URL
export const PATCH_COMPANY_DETAIL_REGIST_URL = (companyCode : number) => `${MAIN_PATH}/${SERVER_COMPANY_MODULE}/${companyCode}`;
// 업체 정보 삭제 URL
export const DELETE_COMPANY_LIST_URL = (companyCode : number) => `${MAIN_PATH}/${SERVER_COMPANY_MODULE}/${companyCode}`;
